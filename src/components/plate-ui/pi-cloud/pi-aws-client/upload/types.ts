...
type ClientGenericFile = ClientGenericFileInfo & FileAndObjectUrl;
type ClientImageFile = ClientImageFileInfo & FileAndObjectUrl;
type ClientFile = ClientGenericFile | ClientImageFile;

type HostedGenericFileInfo = {
  type: "generic";
  url: string;
};

type HostedFileInfo = HostedGenericFileInfo | HostedImageFileInfo;

type HostedImageFileInfo = {
  type: "image";
  url: string;
  width: number;
  height: number;
