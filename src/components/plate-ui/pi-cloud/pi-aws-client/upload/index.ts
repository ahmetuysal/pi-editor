...
type JSendSuccess<D extends Record<string, unknown> = Record<string, never>> = {
  status: "success";
  data: D;
};

type UploadFileSuccessResponse = JSendSuccess<{
...
type UploadFileResponse = UploadFileSuccessResponse | JSendError;
...
export async function uploadFile({
  ...
  // content-type is already set by the formFields
